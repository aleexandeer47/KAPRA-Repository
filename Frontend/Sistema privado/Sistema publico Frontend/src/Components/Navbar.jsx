...
const Nav = () => {
  return (
    <nav className="group fixed left-0 top-0 h-screen w-20 hover:w-64 bg-[#1B263B] text-white shadow-md p-4 overflow-hidden transition-all duration-300 ease-in-out">
      ...
      <ul className="flex flex-col gap-6">
        ...
        <li>
          <Link to="/Order" className="flex items-center justify-center group-hover:justify-start gap-4 px-3 py-3 rounded-xl transition-all duration-200 hover:bg-white/10">
